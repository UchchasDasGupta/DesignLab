...
<?php
	...
	include ("includes/connection.php");
		...
		{
		$sql = "select * from admin_reg where userid = '$userid'";
		$result = mysql_query($sql);
		$count = mysql_num_rows($result);
		if($count == 0){
			header("location:searchadmin.php?wrong_info");
		}else{
...
<form name = "f1" action = "updateadmin1.php" method = "post" enctype = "multipart/form-data" onsubmit = "return validate()">
