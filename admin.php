...
<table>
<tr>
<td><button type="button" onclick="window.location.href = 'regviewadmin.php';" class="buttonsign">Admin Details</button></td>
</tr>
<tr>
<td><button type="button" onclick="window.location.href = 'searchadmin.php';" class="buttonsign">Update Admin Details</button>
</tr>
<tr>
<td><button type="button" onclick="window.location.href = 'deleteadmin.php';" class="buttonsign">Delete Admin Details</button>
</td>
</tr>
</table>
