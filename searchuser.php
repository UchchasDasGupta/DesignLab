...
<body>
<form action = "updateuser.php" method = "post" enctype = "multipart/form-data" onsubmit = "return validate()">
<table>
<h1> Search User </h1>

<tr>
<td><h3> Contact No </h3></td>
<td> <input type = "text" name = "contact" placeholder="Contact No.." id = "t1"  ></td>
</tr>
